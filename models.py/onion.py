...
data = pd.read_csv(r"C:\Users\himal\OneDrive\Desktop\Django\crashcourse\crm1\accounts\csv\Onion_cleaned_data.csv")
data.head(5)
...
for data in regressor.predict([[2,3,2022]]):
    price = data
print("Predicted price of onion is Rs ",data)
